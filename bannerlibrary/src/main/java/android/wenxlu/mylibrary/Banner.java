package android.wenxlu.mylibrary;
...
import android.wenxlu.mylibrary.adapter.BannerAdapter;
import android.wenxlu.mylibrary.config.BannerConfig;
import android.wenxlu.mylibrary.config.IndicatorConfig;
import android.wenxlu.mylibrary.indicator.Indicator;
import android.wenxlu.mylibrary.listener.OnBannerListener;
import android.wenxlu.mylibrary.listener.OnPageChangeListener;
import android.wenxlu.mylibrary.transformer.ScaleInTransformer;
import android.wenxlu.mylibrary.util.BannerLifecycleObserver;
import android.wenxlu.mylibrary.util.BannerLifecycleObserverAdapter;
import android.wenxlu.mylibrary.util.BannerUtils;
import android.wenxlu.mylibrary.util.ScrollSpeedManger;
